...
bilgezApp.config(['$routeProvider', '$locationProvider',
    function ($routeProvider, $locationProvider) {
        $routeProvider.
            when('/', {
                templateUrl: 'iframe_partials/main.html',
                controller: 'ucusCtrl'
            })
            //when('/', {
